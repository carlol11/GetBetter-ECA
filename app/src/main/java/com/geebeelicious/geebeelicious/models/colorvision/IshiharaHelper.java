...
public class IshiharaHelper {
    ...
    public IshiharaHelper(ImageView plateView, ImageButton[] buttonList){
        ...
        ishiharaPlates[15] = new IshiharaPlate("flower", 1, R.drawable.flower_tv_1);
        ishiharaPlates[16] = new IshiharaPlate("flower", 3, R.drawable.flower_tv_3);
        ishiharaPlates[17] = new IshiharaPlate("flower", 6, R.drawable.flower_tv_6);
...
//        ishiharaPlates[17] = new IshiharaPlate("ellipse", 6, R.drawable.ellipse_tv_6);
        ...
        ishiharaPlates[21] = new IshiharaPlate("sun", 1, R.drawable.sun_tv_1);
        ishiharaPlates[22] = new IshiharaPlate("sun", 3, R.drawable.sun_tv_3);
        ishiharaPlates[23] = new IshiharaPlate("sun", 6, R.drawable.sun_tv_6);
        ishiharaPlates[24] = new IshiharaPlate("check", 1, R.drawable.check_tv_1);
        ishiharaPlates[25] = new IshiharaPlate("check", 3, R.drawable.check_tv_3);
        ishiharaPlates[26] = new IshiharaPlate("check", 6, R.drawable.check_tv_6);
...
//        ishiharaPlates[26] = new IshiharaPlate("semicircle", 6, R.drawable.semicircle_tv_6);
        ...
        options[5] = new Option("flower", R.drawable.btn_cvt_flower);   //changed
        options[6] = new Option("heart", R.drawable.btn_cvt_heart);
        options[7] = new Option("sun", R.drawable.btn_cvt_sun); //changed
        options[8] = new Option("check", R.drawable.btn_cvt_check); //changed
